...
-- Stores results of AI-driven message analysis and answer suggestions
CREATE TABLE public.ai_msg_analyze (
    ...
    answer_text TEXT, -- AI-generated answer suggestion
...
CREATE INDEX idx_ai_msg_analyze_company_answer_data_source_id ON public.ai_msg_analyze(company_answer_data_source_id);
